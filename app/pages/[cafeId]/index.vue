...
<template>
    <div class="bg-latte p-8 min-h-screen flex flex-col text-coffee">
        ...
        <NuxtLink :to="`/${route.params.cafeId}/barista`">
            <UButton
                class="fixed top-4 right-4 z-10 bg-coffee-500 hover:bg-coffee-600 text-white"
            >
                Be the barista
        ...
        <div class="flex flex-col justify-center grow">
            ...
            <h2
                key="pastOrders"
                class="font-bold text-2xl mb-4 ml-4 sm:ml-6 text-coffee"
            >
                Past Orders
            </h2>
            <UCard
            ...
            >
                <div class="flex flex-col justify-between">
                    ...
                    <div
                        class="font-mono text-gray-500 dark:text-gray-400 text-sm"
                    >
                        #{{ order.$id }}
                    </div>
        ...
        <USlideover
            ...
            :ui="{
                background: 'bg-white',
                overlay: { background: 'bg-coffee/50' },
            }"
        >
            <template #body>
                <div class="p-4">
                    ...
                    <UFormField label="Your name" class="mt-4">
                        <UInput
                            ...
                            class="bg-white text-coffee focus:ring-coffee-500"
                        ></UInput>
                    </UFormField>
                    <div class="flex flex-row justify-end mt-4">
                        <UButton
                            :loading="isOrderSending"
                            size="xl"
                            class="rounded-full bg-coffee-500 hover:bg-coffee-600 text-white"
                            @click="sendCommand"
                            >Order</UButton
                        >
                    </div>
